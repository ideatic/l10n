            ...
            foreach ($domainLocales as $locale) {
                ...
                foreach ($environment->config->projects as $project) {
                    ...
                    foreach ($project->translations ?? [] as $translations) {
                        ...
                        if (isset($translations->includeLocations)) {
                            $serializer->includeLocations = $translations->includeLocations;
                        }
                        if (isset($serializer->transformICU) && isset($translations->transformICU)) {
                            $serializer->transformICU = $translations->transformICU;
                        }
